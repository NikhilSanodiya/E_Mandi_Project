...
function CustomerRegForm() {
  ...
  const submit = (e) => {
    ...
    axios
      .post("https://localhost:44328/api/customer", {
        c_name: customer.name,
        c_aadharno: customer.aadhar,
        c_mobileno: customer.mobile,
        c_address: customer.address,
        c_status: true,
        c_password: customer.password,
        c_regdateandtime: date,
        c_city: customer.city,
        c_pincode: customer.zip,
      })
  ...
  return (
    <div className="formCenter">
      <h3 style={{color:"#fff"}}>Customer Registration</h3>
